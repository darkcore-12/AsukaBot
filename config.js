...
global.owner = [
  [ '51928616320', 'propietario: DarkCore 👑', true ],
  [ '51968382008', 'propietario: Sofia 👑']
]; 

// <-- Corchete de cierre y coma añadidos
//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*

global.mods = ['51928616320']
global.suittag = ['51928616320'] 
global.prems = []
...
global.vs = '2.2.0'
global.vsJB = '5.0'
global.nameqr = '𝗔𝘀𝘂𝗸𝗮𝗕𝗼𝘁'
global.namebot = '𝗔𝘀𝘂𝗸𝗮𝗕𝗼𝘁'
...
global.packname = '𝗔𝘀𝘂𝗸𝗮𝗕𝗼𝘁'
global.botname = '𝗔𝘀𝘂𝗸𝗮𝗕𝗼𝘁'
global.wm = '𝗔𝘀𝘂𝗸𝗮𝗕𝗼𝘁'
global.author = 'Made By 𝑫𝒂𝒓𝒌𝑪𝒐𝒓𝒆'
global.dev = '© ⍴᥆ᥕᥱrᥱძ ᑲᥡ 𝑫𝒂𝒓𝒌𝑪𝒐𝒓𝒆'
global.textbot = '𝗔𝘀𝘂𝗸𝗮𝗕𝗼𝘁 • Powered By 𝑫𝒂𝒓𝒌𝑪𝒐𝒓𝒆'
global.etiqueta = '𝗔𝘀𝘂𝗸𝗮𝗕𝗼𝘁'
